...
WEST of the fault -- use chev_classify_e_vol_horizon.py for east of the fault
...
# Work in time -- these are different limits than Shell
...
for file in hor_files[:]:
    ...
    print('Starting calc @ %s' % t0.strftime('%H:%M:%S'))
    ...
    print("{} Distances from horizon calculated in {}"
